...
class App extends Component {
  ...
  handleEdit = () => {
    ...
    const updatedColumn = columns.updateIn([editingColumnIndex, "tasks"], (tasks) =>
  ...
  handleSaveDrag = (result) => {
    ...
    if (reason === "DROP" && destination) {
      ...
      updatedColumn = updatedColumn.updateIn([destinationColumnIndex, "tasks"], (tasks) =>
        tasks.insert(destination.index, task)
      );
      this.setState(
        {
          columns: fromJS(updatedColumn),
